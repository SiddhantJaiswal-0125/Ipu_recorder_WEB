...
class ExportSummaryIpuUsageHelper {
  static Future<JobResponse> triggerExportJob(
    ...
    String url =
        "${currentSession.serverUrl}/${Constants.Export_AllLinkedOrgReport}";
  ...
  static Future<void> saveApiResponseAsZip(
      User currentSession, JobResponse jobResponse) async {
    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        Archive archive = Archive()
          ..addFile(
              ArchiveFile('response.csv', responseBody.length, responseBody));
